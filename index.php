    ...
    <body>
        ...
        <div class="sidebar-navigation hidde-sm hidden-xs">
            <div class="logo">
                ...
                <img src="img/saar15 CLIPART.png" alt="" class="image-active" style="display:none">
            </div>
            <nav>
                <?php
...
#ProudIITPian</p>
            ...
            <section class="timeline" id="timelin">
                <div class="section-heading" style="text-align: center; margin-bottom: 10px;">
  ...
  <ol>
    <li>
      <div>
        <time>2-Jan</time> At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
      </div>
    </li>
    <li>
      <div>
        <time>7-Jan</time> Proin quam velit, efficitur vel neque vitae, rhoncus commodo mi. Suspendisse finibus mauris et bibendum molestie. Aenean ex augue, varius et pulvinar in, pretium non nisi.
      </div>
    </li>
    <li>
      <div>
        <time>12-Jan</time> Proin iaculis, nibh eget efficitur varius, libero tellus porta dolor, at pulvinar tortor ex eget ligula. Integer eu dapibus arcu, sit amet sollicitudin eros.
      </div>
    </li>
    <li>
      <div>
        <time>17-Jan</time> In mattis elit vitae odio posuere, nec maximus massa varius. Suspendisse varius volutpat mattis. Vestibulum id magna est.
      </div>
    </li>
    <li>
      <div>
        <time>22-Jan</time> In mattis elit vitae odio posuere, nec maximus massa varius. Suspendisse varius volutpat mattis. Vestibulum id magna est.
      </div>
    </li>
    <li>
      <div>
        <time>27-Jan</time> In mattis elit vitae odio posuere, nec maximus massa varius. Suspendisse varius volutpat mattis. Vestibulum id magna est.
      </div>
    </li>
    <li>
      <div>
        <time>2-Feb</time> In mattis elit vitae odio posuere, nec maximus massa varius. Suspendisse varius volutpat mattis. Vestibulum id magna est.
      </div>
    </li>
    <li>
      <div>
        <time>7-Feb</time> Aenean condimentum odio a bibendum rhoncus. Ut mauris felis, volutpat eget porta faucibus, euismod quis ante.
      </div>
    </li>
    <li>
      <div>
        <time>12-Feb</time> Vestibulum porttitor lorem sed pharetra dignissim. Nulla maximus, dui a tristique iaculis, quam dolor convallis enim, non dignissim ligula ipsum a turpis.
      </div>
    </li>
    <li>
      <div>
        <time>17-Feb</time> In mattis elit vitae odio posuere, nec maximus massa varius. Suspendisse varius volutpat mattis. Vestibulum id magna est.
      </div>
    </li>
    <li>
      <div>
        <time>2-Jan</time> In mattis elit vitae odio posuere, nec maximus massa varius. Suspendisse varius volutpat mattis. Vestibulum id magna est.
      </div>
    </li>
    <li>
      <div>
  ...
  <div class="arrows">
    <button class="arrow arrow__prev disabled" disabled>
      <i class="fa fa-angle-left" alt="prev timeline arrow" style="color: #26C1ED; font-size: 50px; font-weight: bold;"></i>
    </button>
    <button class="arrow arrow__next">
      <i class="fa fa-angle-right" alt="next timeline arrow" style="color: #26C1ED; font-size: 50px; font-weight: bold;"></i>
    </button>
  </div>
  </section>
    </section>
  ...
  $(document).ready(function(){
      ...
      $(window).scroll(function(){
        ...
        if(scrolltop <50){
            ...
            $('.logo .image-active').css({"display":"none"});
            ...
            $('.sidebar-navigation li a i').css({"color":"#fff"});

        }
        else if(scrolltop >50){
            $('.sidebar-navigation li:nth-child(1) a i').css({"color":"#2cc2de"});
            $('.sidebar-navigation li:nth-child(2) a i').css({"color":"#0ad80f"});
            $('.sidebar-navigation li:nth-child(3) a i').css({"color":"#fc1c0d"});
            $('.sidebar-navigation li:nth-child(4) a i').css({"color":"#fb770d"});
            $('.sidebar-navigation li:nth-child(5) a i').css({"color":"#fac611"});
            $('.sidebar-navigation nav a').css({"color":"#3f3e3c"});
            $('.sidebar-navigation').css({"background-color":"#fff"});
            $('.sidebar-navigation .logo').css({"background-color":"#fff"});
            $('.logo .static').css({"display":"none"});
            $('.logo .image-active').css({"display":"block"});
